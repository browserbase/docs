...
[Session Replay](/sessions), and finally start a session using your code.
...
<Steps>
  ...
  <Step title="Inspect your Browser Session">
    ...
    Learn more on [Session Replay](/sessions) capabilities on the Sessions documentation.
...
<Steps>
  ...
  <Step title="Update and your code">
    ...
    (async () => {
      ...
      const driver = new webdriver.Builder()
        ...
        .usingServer(
          `http://api.browserbase.com/webdriver` // Selenium only supports HTTP
        )
        .build();
  ...
  <Step title="Inspect the completed Session">
    ...
    Select your Session to access its [Session Replay](/sessions) (showcased in the [previous section](#your-first-session)).
