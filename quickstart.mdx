...
Let's run a first session from the Playground and inspect it with the
[Session Debugger](/features/sessions), and finally start a session from code.
...
<Steps>
  ...
  <Step title="Update your code or clone a template">
    ...
    <Tabs>
      ...
      <Tab title="Playwright (JavaScript)">
      ...
      <Tab title="Puppeteer (JavaScript)">
      ```javascript
