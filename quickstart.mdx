...
Let's run a first session from the Playground, inspect it with
[Session Replay](/features/sessions), and finally start a session using your
code.
...
<Steps>
  ...
  <Step title="Inspect your Browser Session">
    ...
    The Session page offers you a full Session Replay with screen recording, network, and Chrome Console logs for each step:

    <Frame caption="Session Replay gives you full visibility on a Session's run.">
      <img src="/images/quickstart/session-replay.png" />
    </Frame>

    Learn more on [Session Replay](/features/sessions) capabilities on the Sessions documentation.
...
<Steps>
  ...
  <Step title="Inspect the completed Session">
    ...
    Select your Session to access its [Session Replay](/features/sessions) (showcased in the [previous section](#your-first-session)).
