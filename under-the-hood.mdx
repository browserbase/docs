...
fleet of Browser instances as well as the maintenance burden of integrating with
...
[Session Replay](/features/session-replay) is the central feature, providing
...
- Maintaining the [Sessions's state](/features/sessions#sessions-lifecycle) by
  managing the Serverless infrastructure and resources allocation
- Capturing
...
Each Browser Session runs in a isolated container with a dedicated ressources,
